...
static inline size_t __get_and_set_prop(std::string_view promptMsg, char *&defaultValue, char *&st, size_t* stlen, std::string &badcharlist = badchars, size_t maxStLen = 254) {
